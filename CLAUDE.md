...
- `原文/道德经-王弼本.md` — the sole textual standard for all quoted 原文 (王弼通行本, traditional characters, split and numbered from `daodejing.md`; editorial notes in its header, e.g. 第33章 restoration, 第31章 校勘括号)
...
- `## 原文`: the full chapter as a blockquote, copied verbatim from `原文/道德经-王弼本.md` — traditional characters including editorial brackets 〔〕, never converted to simplified, never paraphrased. Any 原文 change must first be made in the base file, with a header 校记 note.
