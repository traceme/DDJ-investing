...
- `codex/第01章.md` … `第81章.md` — the independent Codex deep-analysis edition: exact source text followed by `深层原理`, `投资推演`, and a practical recommendation under 100 Chinese characters; `codex/README.md` is its methodology and index
...
Codex files intentionally use a separate analytical format: `## 原文`, `## 深层原理`, `## 投资推演`, and `## 实操建议`, followed by navigation. Keep each advice paragraph below 100 characters and preserve the methodology, research links, and disclaimer in `codex/README.md`.
