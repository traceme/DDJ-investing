...
BOOKS: dict[str, Book] = {
    ...
    "onebook": rules_book("onebook", "读道德经悟投资心法.pdf",
                          ("总纲", "十二条根本规矩", "第一章", "第八十一章", "案例账户", "三眼说", "免责声明"),
                          "哲学随笔与投资常识的融合，不构成任何具体投资建议；案例账户归一为 100 单位，不对应真实金额"),
    "value": rules_book("value", "价值投资者投资体系与交易系统.pdf",
                        ("卷首", "阅读说明", "第一章", "第十八章", "远川软件", "原预警阈值登记表", "附录五"),
                        "投资方法与流程说明，不构成任何具体投资建议或下单授权；案例公司与组合均为虚构，100 单位为教学尺度"),
